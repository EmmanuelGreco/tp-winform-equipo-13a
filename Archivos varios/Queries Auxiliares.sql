...
UPDATE ARTICULOS SET Nombre = 'Prueba' WHERE Id = 13

SELECT * FROM ARTICULOS
DELETE FROM ARTICULOS WHERE Id >= 6 --AND Id <= X
DBCC CHECKIDENT (ARTICULOS, RESEED, 6)
...
/*
SELECT * FROM MARCAS
DELETE FROM MARCAS WHERE Id >= 6 --AND Id <= X
DBCC CHECKIDENT (MARCAS, RESEED, 6)
*/
...
/*
SELECT * FROM CATEGORIAS
DELETE FROM CATEGORIAS WHERE Id >= 5 --AND Id <= X
